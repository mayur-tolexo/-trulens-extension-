...
// A larger marketing image for the store tile — kept outside public/ so it is
// NOT copied into dist/ or the packaged extension zip.
await sharp(svg, { density: 512 }).resize(440, 280, { fit: 'contain', background: { r: 255, g: 255, b: 255, alpha: 1 } })
  .png().toFile(new URL('../store-assets/promo-440x280.png', import.meta.url).pathname);

console.log('[build-icons] wrote icon-16/32/48/128.png to public/ and promo-440x280.png to store-assets/');
